...
REGION: CORE
TAG: CORE.SDK.SENTINEL_AGENT.MAIN
...
WHERE = agents\CORE\L5_Governance\sentinel_agent.py
WHEN = 2026
...
TAG: LEEWAY.CORE.SENTINEL_AGENT_PY

5WH:
WHAT = Core High-Level Agent component in the Sovereign Spine
WHY = Powers the Governance capabilities of the LeeWay ecosystem

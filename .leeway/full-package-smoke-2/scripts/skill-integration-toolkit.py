...
REGION: CORE
TAG: CORE.SDK.SKILL_INTEGRATION_TOOLKIT.MAIN
...
5WH:
WHAT = skill-integration-toolkit module
WHY = Part of CORE region
WHO = LEEWAY Align Agent
WHERE = .leeway\full-package-smoke-2\scripts\skill-integration-toolkit.py
WHEN = 2026

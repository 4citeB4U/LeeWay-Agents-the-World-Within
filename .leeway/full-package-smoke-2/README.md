# 🧠 Leeway Skills - LLM Lifelong Learning System
...
### Leeway Skills + Workflows + Lifelong Learning = LLM School
...
**NEW**: Leeway Skills is now available as an **MCP (Model Context Protocol) server**, allowing Agent Lee and other LLMs to use all 44 skills as first-class callable tools.

### Install As Full NPM SDK

You can now install the **full Leeway Skills application** as one npm package:

```powershell
npm install @leeway/skills-sdk
```
...
leeway-skills info
leeway-skills-mcp
leeway-skills-badge .\public "My App" mcp-server
leeway-skills extract .\leeway-skills-app
```
...
- **[Agent Lee Integration](documents/AGENT_LEE_INTEGRATION.md)** - Connect Agent Lee to Leeway Skills
...
- **[NPM SDK Guide](documents/LEEWAY_NPM_SDK.md)** - Install the full Leeway Skills application from npm

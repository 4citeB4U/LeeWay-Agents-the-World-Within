# Leeway Skills NPM SDK

## Purpose

The root package now ships the **full Leeway Skills application** as an installable npm SDK.
...
- `leeway-skills extract` can materialize that bundle into a standalone directory if you want a writable local copy outside `node_modules`.
